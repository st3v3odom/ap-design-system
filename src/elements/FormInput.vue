...
.input {
  ...
  input {
    ...
    color: set-text-color($color_gray_10, $color-white);
    margin: 0;
    border: 0;
    box-shadow: inset 0 1px 0 0 rgba($color_gray_10, 0.07), 0 0 0 1px tint($color_gray_10, 80%);
    ...
    &:hover,
    &[hover] {
      box-shadow: 0 1px 5px 0 rgba($color_gray_10, 0.07), 0 0 0 1px tint($color_gray_10, 60%);
    }
    &:focus,
    &[focus] {
